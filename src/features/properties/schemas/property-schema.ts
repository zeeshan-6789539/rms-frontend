...
export const propertySchema = z.object({
  ...
  addressLine2: z.string().max(500, "addressLine2Length").optional(),
  city: z.string().min(1, "cityLength").max(100, "cityLength"),
  state: z.string().max(100, "stateLength").optional(),
  postalCode: z.string().max(20, "postalCodeLength").optional(),
  status: z.boolean(),
});
